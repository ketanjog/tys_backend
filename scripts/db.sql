...
CREATE TABLE hunches (
  hunch_id INT NOT NULL AUTO_INCREMENT,
  user_id INT NOT NULL,
  hunch VARCHAR(140) NOT NULL,
  date_hunch DATETIME NOT NULL,
...
INSERT INTO hunches(user_id, hunch, date_hunch) VALUES
(1, "test hunch", "2001-01-01 22:00:00"),
(2, "test hunch2", "2002-01-01 22:00:00"),
(3, "test hunch3", "2003-01-01 22:00:00"),
(4, "test hunch42", "2004-01-01 22:00:00"),
(5, "test hunch420", "2005-01-01 22:00:00");
